...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Critic.image'
        db.alter_column(u'app_critic', 'image', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Critic.image'
        db.alter_column(u'app_critic', 'image', self.gf('django.db.models.fields.CharField')(max_length=300))
